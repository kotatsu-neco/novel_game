    ...
    for scene_id, scene in scenes.items():
        for step in scene.get("steps", []):
            ...
            if step.get("type") == "choice":
                ...
                if step.get("timeoutNext"):
                    add_edge(graph, edge_counts, scene_id, step.get("timeoutNext"))
                if step.get("timeoutChoiceLabel"):
                    for choice in choices:
                        if choice.get("label") == step.get("timeoutChoiceLabel"):
                            add_edge(graph, edge_counts, scene_id, choice.get("next"))
